...
It reads a channels.conf file [cst]zap format in the current directory to
decode the channel names (at the moment)
...
DEBUGGING
---------
dvbsnoop -s sec 18 -b -n 200 > EIT.bin
tv_garb_dvb -i EIT.bin -f EIT.xmltv
